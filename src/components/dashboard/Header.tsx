...
export function DashboardHeader() {
  return (
    <header className="h-14 border-b border-border/50 bg-surface/50 backdrop-blur-sm flex items-center justify-between px-4 sm:px-6 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        <Link href="/dashboard/alerts" className="text-muted hover:text-muted-light transition-smooth relative">
        ...
        <Link href="/dashboard/settings" className="text-muted hover:text-muted-light transition-smooth">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
