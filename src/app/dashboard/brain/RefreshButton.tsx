  ...
  async function handleRefresh() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setMessage(`Scanned — ${data.quotesFetched}q · ${data.candlesWritten}c · ${data.indicatorsComputed}i · ${data.liquiditySweeps}sw · ${data.structureEvents}e · ${data.durationMs}ms`);
