...
/**
 * Lightweight crypto-only candle refresh. Runs on its own cron schedule
 * (see vercel.json) independent of the main 2-minute scan so BTC + ETH
 * candles stay fresh without waiting for the full scan pipeline.
 *
 * No downstream analyzers — just candle fetch + persist. Typical runtime
 * well under 10s.
 */
