// Bullish FVG Inversion signals — populated by the brain's 2-min scan cron
// via `src/lib/brain/strategies/bullish-fvg-inversion.ts`. This route hands
// the client the latest snapshot of active signals.
...
export async function GET() {
  try {
    ...
    const msg = err instanceof Error ? err.message : "bullish_fvg_inversion_failed";
    return NextResponse.json(
